...
public class Alquerque extends Application {
    ...
    private void mediaMove(){
        File file = new File("move.wav");
        String absolutePath = file.getAbsolutePath();
        String uriString = "file:///" + absolutePath.replace("\\", "/");
...
//               System.out.println("newX - " + newX + " e newY - " +newY );
               ...
               File file = new File("captura.mp3");
                String absolutePath = file.getAbsolutePath();
                String uriString = "file:///" + absolutePath.replace("\\", "/");

                Media media2 = new Media(uriString);
    ...
    public void start(Stage stage) throws Exception {
        ...
        File file = new File("background.mp3");
        String absolutePath = file.getAbsolutePath();
        String uriString = "file:///" + absolutePath.replace("\\", "/");

        Media media4 = new Media(uriString);
